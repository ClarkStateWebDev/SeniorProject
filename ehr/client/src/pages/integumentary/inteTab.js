...
import InteTable from './inteTable';



class InteTab extends Component {
                ...
                <br></br><br></br>
                 ...
                 <AppBar position="static" style={{maxWidth: '100%'}}>
                        <Tabs id='tabs' style={{backgroundColor: '#e9ecef', color: 'black'}}>
                            <Tab id='integumentary' label="Integumentary" class="activ" href='/integumentary'/>
