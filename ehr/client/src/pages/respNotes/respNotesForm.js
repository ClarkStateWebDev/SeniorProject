    ...
    return (
      <div style={{ textAlign: 'center' }}>
        <Button color="info" class="btn btn-warning" onClick={() => setShow(!show)} style={{float: 'right', marginRight: '32px', background: '#F5DE36', color: 'black'}}>
          Add/Edit Respiratory Notes
        </Button>
        <Modal
          show={show}
          toggle={() => setShow(!show)}
          title="Respiratory Notes Form"
          body={
            <div>
            <h7>Respiratory Notes</h7>
              <TextField
                name="test_field" defaultValue="enter assessment notes" rows={5}
              />

            <h7>Respiratory Interventions</h7>
              <TextField
                name="test_field" defaultValue="List appropriate respiratory interventions" rows={5}
              />
