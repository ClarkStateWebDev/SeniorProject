...
import SchedMedsTable from './schedMedsTable';
        ...
        <>
            ...
            <br></br><br></br>
                 ...
                 <Tabs id='tabs' style={{backgroundColor: '#e9ecef', color: 'black'}}>
                            <Tab id='schedMeds' label="Scheduled Medications" class="activ" href='/scheduled-medications'/>
