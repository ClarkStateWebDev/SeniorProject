...
import DressingTableForm from './dressingTableForm';

class DressingTable extends Component {
    render() {

        return (
            <>
            <div>
                <DressingForm></DressingForm>
            </div>
            {/* table */}
                <div id="singleTable" class="table-wrapper-scroll-y my-custom-scrollbar" style={{width: '100%', padding: '15px'}}>
                        <table class="table table-borderless table-striped" >
                            ...
                            <tr>
                                ...
                                <td>None</td>
                                {/* Edit form */}
                                <td><DressingTableForm></DressingTableForm></td>
                                {/* Delete button */}
