...
--
-- Table structure for table `medication_admin`
--
...
CREATE TABLE `medication_admin` (
  `Medication_Admin_ID` int NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`Medication_Admin_ID`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `medication_admin`
--

LOCK TABLES `medication_admin` WRITE;
/*!40000 ALTER TABLE `medication_admin` DISABLE KEYS */;
/*!40000 ALTER TABLE `medication_admin` ENABLE KEYS */;
UNLOCK TABLES;
